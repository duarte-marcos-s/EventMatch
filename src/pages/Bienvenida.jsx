    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-600 to-pink-500 flex items-center justify-center">
      <div className="bg-white rounded-3xl shadow-2xl p-12 max-w-md w-full mx-4 text-center">
        ...
        <div className="flex flex-col gap-4">
          <button
            onClick={() => navigate('/registro?tipo=organizador')}
            className="bg-purple-600 hover:bg-purple-700 text-white font-semibold py-4 px-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-200 text-lg"
          >
            🗂️ Soy Organizador
          </button>
          <button
            onClick={() => navigate('/registro?tipo=proveedor')}
            className="bg-pink-500 hover:bg-pink-600 text-white font-semibold py-4 px-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-200 text-lg"
          >
            🛠️ Soy Proveedor
          </button>
        </div>
